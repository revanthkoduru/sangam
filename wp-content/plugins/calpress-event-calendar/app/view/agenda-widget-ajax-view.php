          ...
          <tbody>
            ...
            <tr>
                <td colspan="3" id="prev">
                    <a class="calp-widget-nav" offset="<?php echo $links['previous']['offset'] ?>" instance="<?php echo $calp_instance; ?>" href="#">« <?php echo $links['previous']['text'] ?></a>
                </td>
                <td class="pad">&nbsp;</td>
                <td colspan="3" id="next">
                    <a class="calp-widget-nav" offset="<?php echo $links['next']['offset'] ?>" instance="<?php echo $calp_instance; ?>" href="#"><?php echo $links['next']['text'] ?> »</a>
                </td>
            </tr>
            </tfoot>
        </table>
